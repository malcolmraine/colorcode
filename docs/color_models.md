...
m = color_model.YIQ_Model()
rgb = (0.5, 0.4, 0.3)
y, i, q = m.from_rgb(*rgb)
rgb_back = m.to_rgb(y, i, q)
```
...
m = color_model.ColorModel.create(color_model.ColorModelType.HSV)
```
